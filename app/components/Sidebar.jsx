...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {open && (
        <div onClick={() => setOpen(false)} style={{ position:'fixed',inset:0,background:'rgba(0,0,0,0.55)',zIndex:9998,backdropFilter:'blur(3px)',WebkitBackdropFilter:'blur(3px)' }} />
      )}
      ...
      <div style={{
        ...
        <div style={{ padding:'16px 12px',flex:1 }}>
          ...
          {!installed && (
            <button onClick={handleInstall} style={{ display:'flex',alignItems:'center',gap:12,padding:'11px 12px',borderRadius:14,marginBottom:4,width:'100%',border:'none',background:'transparent',color:txt,cursor:'pointer',fontFamily:'inherit',transition:'all 0.15s' }}>
          ...
          {installed && (
            <div style={{ display:'flex',alignItems:'center',gap:12,padding:'11px 12px',borderRadius:14,marginBottom:4 }}>
              <span style={{ opacity:0.65 }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4caf50" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              </span>
