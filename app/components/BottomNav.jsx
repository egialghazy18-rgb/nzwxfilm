...
const links = [
  { href: '/', label: 'Beranda', icon: (active) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill={active ? '#fff' : 'none'} stroke={active ? '#fff' : '#90a4ae'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>
    </svg>
  )},
  { href: '/movies', label: 'Film', icon: (active) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#fff' : '#90a4ae'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {links.map(l => {
        ...
        return (
          <Link key={l.href} href={l.href} style={{
            ...
            background: active ? 'linear-gradient(135deg, #1565c0, #0d47a1)' : 'transparent',
