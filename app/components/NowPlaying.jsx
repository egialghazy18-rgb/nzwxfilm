  ...
  return (
    <div style={{ marginBottom: 8, position: 'relative' }}>
      <div style={{
        ...
        pointerEvents: 'none',
        maskImage: 'radial-gradient(ellipse 120% 100% at 50% 50%, black 10%, transparent 70%)',
        WebkitMaskImage: 'radial-gradient(ellipse 120% 100% at 50% 50%, black 10%, transparent 70%)',
      }} />
