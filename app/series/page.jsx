                ...
                <div style={{position:'relative', aspectRatio:'2/3'}}>
                  {f.poster_path
                    ...
                    : <div style={{width:'100%',height:'100%',background:'#e3eaf5',display:'flex',alignItems:'center',justifyContent:'center'}}>
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#90a4ae" strokeWidth="1.5"><rect x="2" y="7" width="20" height="15" rx="2"/><polyline points="17 2 12 7 7 2"/></svg>
                      </div>
                  }
